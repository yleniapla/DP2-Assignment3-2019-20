 ...
 *       &lt;sequence>
 *         &lt;element name="shelf" type="{}MyBookshelfType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class MyBookshelves {
    ...
    protected List<MyBookshelfType> shelf;
     ...
     * 
     */
    public List<MyBookshelfType> getShelf() {
        if (shelf == null) {
            shelf = new ArrayList<MyBookshelfType>();
        }
        return this.shelf;
    }
